	 	 	...
	 	 	<div> 
	 	 		<struts:form id="login-form" action="/teacher/teacher_login" method="post" cssClass="default-form">
	 	 			<br><ul>
	 	 				...
	 	 				<li>
	 	 					<span class="left-span"><label for="password" >密码</label></span>
	 	 					<span class="right-span">
	 	 						<input type="password" class="" id="password" name="user.password" placeholder="请输入登录密码">
	 	 					</span>
	 	 				</li>
	 	 				<li>
	   ...
	   <div class="recommend-lesson">
	   		...
	   		<div class="lessons">
	   			<ul>
	   				...
	   				<li class="lesson-hover-box">
	   					<a href="#" title="C++语言程序设计基础" target="_blank">
	   						<div class="lesson-img">
		   						<img src="/mucCollege/images/lesson.jpg" title="C++语言程序设计基础" alt="C++语言程序设计基础"/>
		   					</div>
	   				...
	   				<li class="lesson-hover-box">
	   					<a href="#" title="面向对象软件开发实践之基本技能训练发实践之基本技能训练" target="_blank">
	   						<div class="lesson-img">
		   						<img src="/mucCollege/images/lesson.jpg" alt="面向对象软件开发实践之基本技能训练发实践之基本技能训练"/>
		   					</div>
		   					<div class="lesson-info">
