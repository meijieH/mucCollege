   ...
   <%@include file="/common/topbar.jsp"%>
   	<div class="page-center">
				...
				<form action="teacher/teacher_addCourse" method="post">
					<ul>
						...
						<li>
							...
							<span class="right-span"><input type="number" name="teacourse.couscore" min="1"></span>
						</li>
						<li>
							<span class="left-span">*课程学时</span>
							<span class="right-span"><input type="number" name="teacourse.coutime"  min="1"></span>
						</li>
						<li>
							<span class="left-span">课程名</span>
							<span class="right-span rspantext"><s:property value="course.coursename"/></span>
						</li>
						<li>
							<span class="left-span">课程类别</span>
							<span class="right-span rspantext"><s:property value="course.subject.subjectname"/></span>
						</li>
						<li>
							<span class="left-span">课程描述</span>
							<span class="right-span rspantext"><s:property value="course.detail"/></span>
						</li>
		...
		<div class="page-center-left">
		    <h1 class="content-title"><i class="fa fa-thumb-tack" aria-hidden="true"></i>申请课程</h1>
	        <div class="content-describe">您可以在此申请开设课程，新开设的课程会进入审核状态，暂时不能在课程列表中选择，请耐心等待审核通过。</div>
		</div>
	</div>	
