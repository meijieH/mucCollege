	...
	<div class="lesson-detail">
		<div class="lesson-detail-left">
			...
			<div class="ld-box">
				...
				<ul class="ld-lists">
					<li><a href="student/study/waredetail.jsp" target="_blank">
							<p>
								指令的机器级表示 .ppt&nbsp;
								<time>2016/1/2</time>
							</p> </a></li>
			...
			<div class="ld-box">
				...
				<ul class="ld-lists">
					<li><a href="" target="_blank">
							<p>
								简单的课堂小练习&nbsp;
								<time>2016/1/2 23:00</time>
							</p> </a></li>
					<!-- 添加试卷 -->
					<li><a data-toggle="modal" data-target="#addTest"
						class="add-paper">+ 添加考试</a></li>
					<li></li>
				</ul>
			</div>
		</div>
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="addtest-ways">
						<div onclick="window.open('test/test_getMyTestpapers')">
							<div>从我的试卷中选择</div>
						...
						</div onclick="window.open('test/test_toAutoPapers')">
	...
	<div class="lesson-detail">
		<div class="lesson-detail-left">
			...
			<div class="ld-box">
				...
				<ul class="ld-lists">
					<li><a href="teacher/mylesson/stumanage.jsp" target="_blank">
							<p>查看学生</p> </a></li>
					<li>添加学生</li>
					<li>删除学生</li>
				</ul>
